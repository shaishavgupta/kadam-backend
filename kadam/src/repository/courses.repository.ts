...
import { Category, Module, Course, ContentWithModule, PaginatedCoursesResponse, Vector, ExploreCourse, CreateCourseRequest, Path, CreatePathRequest, UpdatePathRequest } from "../schemas/course";
